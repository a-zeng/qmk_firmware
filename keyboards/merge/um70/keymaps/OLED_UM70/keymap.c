...
[_BASE] = LAYOUT_rspace_2u_bksp(
    ...
    KC_MEDIA_PLAY_PAUSE,    KC_LCTL, KC_LGUI, KC_LALT, MO(1), KC_SPC,                   KC_SPC, KC_RALT, KC_RCTL,                               KC_LEFT, KC_DOWN, KC_RGHT
),
...
static void print_status_narrow(void) {
    ...
    render_luna(0, 11);     // Functions similar to the set cursor function
